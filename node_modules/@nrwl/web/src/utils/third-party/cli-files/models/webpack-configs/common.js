...
function getCommonConfig(wco) {
    ...
    const { webpack, webpackSources, isWebpack5, } = require('../../../../../webpack/entry');
    ...
    if (scriptsOptimization) {
        ...
        extraMinimizers.push(new TerserPlugin({
            ...
            chunkFilter: isWebpack5
                ? undefined
                : (chunk) => !globalScriptsByBundleName.some((s) => s.bundleName === chunk.name),
            terserOptions,
        }), 
    ...
    return {
        ...
        context: projectRoot,
        entry: entryPoints,
        output: Object.assign(Object.assign({}, (isWebpack5 ? {} : { futureEmitAssets: true })), { path: path.resolve(root, buildOptions.outputPath), publicPath: buildOptions.deployUrl }),
        ...
        optimization: Object.assign({}, (isWebpack5
            ? {
                emitOnErrors: false,
