...
const exec_1 = require("../core/project-graph/daemon/exec");
...
exports.commandsObject = yargs
    ...
    .command('daemon:start', 'EXPERIMENTAL: Start the project graph daemon server (either in the background or the current process)', (yargs) => withDaemonStartOptions(yargs), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    if (args.background) {
        return exec_1.startInBackground();
    }
    return exec_1.startInCurrentProcess();
}))
    .command('daemon:stop', 'EXPERIMENTAL: Stop the project graph daemon server', (yargs) => yargs, () => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return exec_1.stop(); }))
